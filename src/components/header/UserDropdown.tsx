...
export default function UserDropdown() {
  ...
  const handleSignOut = () => {
    // Remove JWT token (or session) from localStorage or cookies
    localStorage.removeItem("authToken");

    // Optionally, clear user-related state in your context or Redux
      ...
      >
        ...
        <div className="flex flex-col items-start">
          ...
          <span className="block text-xs">
            <p className="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-1 rounded-md inline-block">
              Role: {user?.role || "User"}
            </p>
          </span>
        </div>

        {/* Dropdown Arrow (Now Next to Text) */}
        <svg
